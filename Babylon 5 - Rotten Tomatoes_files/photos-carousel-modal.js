define(function() { return webpackJsonp([8,15],{
...
var _photoswipe = __webpack_require__(466);

var _photoswipe2 = _interopRequireDefault(_photoswipe);

var _photoswipeDistPhotoswipeUiDefault = __webpack_require__(465);
...
var _PhotoSwipeJs = __webpack_require__(223);

var _PhotoSwipeJs2 = _interopRequireDefault(_PhotoSwipeJs);

var _lodashPick = __webpack_require__(462);
...
var _PhotoSwipeGalleryJs = __webpack_require__(538);
...
var _PhotosModal = __webpack_require__(816);

var _PhotosModal2 = _interopRequireDefault(_PhotosModal);

var _PhotosCarouselItem = __webpack_require__(815);

var _PhotosCarouselItem2 = _interopRequireDefault(_PhotosCarouselItem);
...
var IMAGE_ID_LOCATION_HASH_REGEX = /&pid=([a-zA-Z0-9-]+)/;

var PhotosCarousel = function (_Component) {
    _inherits(PhotosCarousel, _Component);
    ...
    function PhotosCarousel() {
        ...
        _classCallCheck(this, PhotosCarousel);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PhotosCarousel.__proto__ || Object.getPrototypeOf(PhotosCarousel)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            isModalOpen: false,
            itemIndex: null
        }, _this.handlePhotoClick = function (id) {
            _this.setState({ isModalOpen: true, itemIndex: _this.getItemIndexFromId(id) });
        }, _this.handleModalClose = function () {
            _this.setState({ isModalOpen: false });
        }, _this.handlePhotoViewed = function (photoSwipe) {
            var sendMOBPhotoViewModalEvent = _this.props.sendMOBPhotoViewModalEvent;

            sendMOBPhotoViewModalEvent(photoSwipe.currItem.id);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(PhotosCarousel, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            // It's necessary to setState here (though it's frowned upon in
            // componentDidMount) because PhotoSwipe doesn't like to init rendered
            // visible.

            var initialItemId = PhotosCarousel.parseImageIdFromLocation(this.props.getWindowLocation());

            if (initialItemId) {
                this.setState({ // eslint-disable-line react/no-did-mount-set-state
                    isModalOpen: true,
                    itemIndex: this.getItemIndexFromId(initialItemId)
                });
            }
        }
    }, {
        ...
        value: function getItemIndexFromId(id) {
            ...
            return _lodash2.default.findIndex(photos, { id: id });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Carousel2.default,
                    { className: 'PhotosCarousel', mobileSetting: mobileSetting, desktopSetting: desktopSetting },
                    photos.map(function (photo, index) {
                        return _react2.default.createElement(
                            'div',
                            { key: photo.id },
                            _react2.default.createElement(_PhotosCarouselItem2.default, {
                                id: photo.id,
                                index: index,
                ...
                _react2.default.createElement(_PhotosModal2.default, {
                    isOpen: isModalOpen,
                    itemIndex: itemIndex,
                    items: modalItems,
                    onClose: this.handleModalClose,
                    onChange: this.handlePhotoViewed
                })
            );
        }
    }], [{
        key: 'parseImageIdFromLocation',
        value: function parseImageIdFromLocation(location) {
            var result = IMAGE_ID_LOCATION_HASH_REGEX.exec(location.hash);
...
PhotosCarousel.propTypes = {
    photos: _react.PropTypes.arrayOf(_react.PropTypes.shape({
        id: _react.PropTypes.string.isRequired,
        urls: _react.PropTypes.shape.isRequired // keys: names, values: image urls
    })),
    modalItems: _react.PropTypes.arrayOf(_react.PropTypes.shape({
    ...
    sendMOBPhotoViewModalEvent: _react.PropTypes.func.isRequired,
    getWindowLocation: _react.PropTypes.func.isRequired
};
exports.default = PhotosCarousel;
module.exports = exports['default'];
...
var PhotosCarouselItem = function (_Component) {
    _inherits(PhotosCarouselItem, _Component);

    function PhotosCarouselItem() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, PhotosCarouselItem);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PhotosCarouselItem.__proto__ || Object.getPrototypeOf(PhotosCarouselItem)).call.apply(_ref, [this].concat(args))), _this), _this.handlePhotoClick = function (event) {
            event.preventDefault();
            _this.props.onPhotoClick(_this.props.id);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(PhotosCarouselItem, [{
        key: "render",
        value: function render() {
            var _props = this.props,
                alt = _props.alt,
            ...
            var imgEl = void 0;
            if (alt) {
                imgEl = _react2.default.createElement("img", {
                    className: "PhotosCarousel__image",
                    src: thumbnailUrl,
                    alt: alt
                });
            } else {
            ...
            return (
                ...
                _react2.default.createElement(
                    "div",
                    { id: id, "data-index": index },
                    _react2.default.createElement(
                        "div",
                        { className: "PhotosCarousel__item" },
                        _react2.default.createElement(
                            "a",
                            {
                                className: "PhotosCarousel__item-link",
...
PhotosCarouselItem.propTypes = {
    alt: _react.PropTypes.string,
    id: _react.PropTypes.string.isRequired,
    index: _react.PropTypes.number.isRequired,
    thumbnailUrl: _react.PropTypes.string.isRequired,
    onPhotoClick: _react.PropTypes.func.isRequired
};
exports.default = PhotosCarouselItem;
module.exports = exports["default"];
...
var _reactPhotoswipe = __webpack_require__(539);
...
// Number of images to preload before the currently visible image
var PRELOAD_BEFORE_COUNT = 2;
// Number of images to preload after the the currently visible image
var PRELOAD_AFTER_COUNT = 4;

var PhotosModal = function PhotosModal(_ref) {
    ...
    var options = {
        index: itemIndex,
        preload: [PRELOAD_BEFORE_COUNT, PRELOAD_AFTER_COUNT],
...
PhotosModal.propTypes = {
    ...
    itemIndex: _react.PropTypes.number,
...
// module
exports.push([module.i, "#photos-carousel-root {\n  margin: auto -8px; }\n  @media (max-width: 767px) {\n    #photos-carousel-root {\n      margin-left: 0;\n      margin-right: 0;\n      margin-right: -20vw; }\n      #photos-carousel-root .slick-list {\n        max-width: 95vw;\n        overflow: hidden; } }\n\n.PhotosCarousel .CarouselButton {\n  -moz-transform: translateY(-50%);\n  -o-transform: translateY(-50%);\n  -ms-transform: translateY(-50%);\n  -webkit-transform: translateY(-50%);\n  transform: translateY(-50%);\n  top: 50%; }\n\n.PhotosCarousel__item {\n  padding: 5px; }\n\n.PhotosCarousel__item-link {\n  display: block;\n  overflow: hidden;\n  cursor: pointer; }\n  @media (min-width: 768px) {\n    .PhotosCarousel__item-link:hover .PhotosCarousel__image, .PhotosCarousel__item-link.PhotosCarousel__item-link--visible-in-modal .PhotosCarousel__image {\n      -moz-transform: scale3d(1.1, 1.1, 1);\n      -o-transform: scale3d(1.1, 1.1, 1);\n      -ms-transform: scale3d(1.1, 1.1, 1);\n      -webkit-transform: scale3d(1.1, 1.1, 1);\n      transform: scale3d(1.1, 1.1, 1); } }\n\n.PhotosCarousel__image {\n  -moz-transition: transform 0.15s ease-in-out;\n  -o-transition: transform 0.15s ease-in-out;\n  -webkit-transition: transform 0.15s ease-in-out;\n  transition: transform 0.15s ease-in-out; }\n", ""]);
...
// module
exports.push([module.i, "/* PhotoSwipe overrides */\n.pswp {\n  z-index: 70000; }\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./PhotosCarouselModal.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./PhotosCarouselModal.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./PhotosModal.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./PhotosModal.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _PhotosCarouselModal = __webpack_require__(756);

var _PhotosCarouselModal2 = _interopRequireDefault(_PhotosCarouselModal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

/* global document, window */
function mount(element, photos, mobileSetting, desktopSetting) {
    if (!element) {
        throw new Error('Could not find photos root to attach photos component');
    }

    if (photos.length === 0) {
        throw new Error('There are no photos with large thumbnails, so we cannot proceed with replacing photos/videos with carousels');
    }

    var photoModalItems = photos.map(function (photo) {
        return {
            pid: photo.id,
            src: photo.urls.fullscreen,
            w: photo.width,
            h: photo.height
        };
    });

    var sendMOBPhotoViewModalEvent = function sendMOBPhotoViewModalEvent(id) {
        if (window.dataLayer) {
            window.dataLayer.push({ event: 'MOBPhotoViewModal' });
        }
        if (window.ga) {
            window.ga('gtmTracker.send', 'pageview', window.location.pathname + '/modal/pictures/' + id);
        }
    };
    ...
    _reactDom2.default.render(_react2.default.createElement(_PhotosCarouselModal2.default, {
        photos: photos,
        modalItems: photoModalItems,
        mobileSetting: mobileSetting,
        desktopSetting: desktopSetting,
        sendMOBPhotoViewModalEvent: sendMOBPhotoViewModalEvent,
        getWindowLocation: getWindowLocation }), element);
}

module.exports = mount;

if (false) {
    mount(document.getElementById('photos-carousel-root'), window.photos, { slidesToShow: 4, slidesToScroll: 4 }, { slidesToShow: 2, slidesToScroll: 2 });
}
module.exports = exports['default'];
